...
public:
	...
	virtual void DrawTexture(const char* name, RectInt destinationRect, RectInt textureRect, bool flip, float rotation, Vector2 origin, bool repeat, float scaleFactor) const override;
	...
	virtual void DrawCircle(Vector2 center, float radius, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const;

	/** Draws a line */
	virtual void DrawLine(Vector2 pointA, Vector2 pointB, slth::Color color);

	/** Draws a colored polygon on the screen */
	virtual void DrawPolygon(Vector2 center, std::vector<Vector2> points, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const;

	/** Draws a single pixel */
	virtual void DrawPoint(Vector2 center, slth::Color color);

	/** Write text on the screen */
	virtual void DrawText(const char* text, slth::Vector2 position, int size, slth::Color color) const override;
	...
	virtual void SetCameraSize(slth::Vector2 size);

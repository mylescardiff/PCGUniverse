...
void slth::SFMLGraphics::DrawTexture(const char* name, RectInt destinationRect, RectInt textureRect, bool flip, float rotation, Vector2 origin, bool repeat, float scaleFactor) const
{
...
void slth::SFMLGraphics::DrawCircle(Vector2 center, float radius, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const
{
...
void slth::SFMLGraphics::DrawPolygon(Vector2 center, std::vector<Vector2> points, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const
{
...
void slth::SFMLGraphics::DrawPoint(Vector2 center, slth::Color color)
{
...
void slth::SFMLGraphics::DrawText(const char* text, slth::Vector2 position, int size, slth::Color color) const
{
	sf::Text sfText;
...
void slth::SFMLGraphics::DrawLine(slth::Vector2 pointA, slth::Vector2 pointB, slth::Color color)
{
	sf::Vertex line[2];
...
void slth::SFMLGraphics::SetCameraSize(slth::Vector2 size)
{
	m_cameraView = m_pNativeWindow->getView();

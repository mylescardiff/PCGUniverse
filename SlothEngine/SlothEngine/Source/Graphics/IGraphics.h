...
public:
	...
	virtual void DrawText(const char* text, slth::Vector2 position, int size, slth::Color color) const = 0;

	/** Draws a texture , with repeat */
	virtual void DrawTexture(const char* name, RectInt destinationRect, RectInt textureRect, bool flip, float rotation, Vector2 origin, bool repeat, float scaleFactor) const = 0;

	/** Draws a texture */
	SLTH_API virtual void DrawTexture(const char* name, RectInt destinationRect, RectInt textureRect, bool flip, float rotation, Vector2 origin) const
	{
	...
	/** Draws a circle */
	virtual void DrawCircle(Vector2 center, float radius, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const = 0;

	/** Draws a line */
	virtual void DrawLine(Vector2 pointA, Vector2 pointB, slth::Color color) = 0;
	
	/** Draws a polygon */
	virtual void DrawPolygon(Vector2 center, std::vector<Vector2> points, slth::Color fillColor, slth::Color outlineColor, float outlineWeight) const = 0;

	/** Draws a single pixel */
	virtual void DrawPoint(Vector2 center, slth::Color color) = 0;
	...
	virtual void SetCameraSize(slth::Vector2 size) = 0;

...
public:
	...
	SLTH_API static float PerlinNoise(slth::Vector2 vec, u32 seed);

	SLTH_API static float GetPerlinNoise(slth::Vector2 vec, float maxX, float maxY, float noiseInputRange, u32 seed);

	SLTH_API static float GetOctavePerlinNoise(slth::Vector2 vec, float maxX, float maxY, float noiseInputRange, int numOctaves, float persistance, u32 seed);
